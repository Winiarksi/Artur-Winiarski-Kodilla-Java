...
public class ForumComment {
    ...
    public ForumComment ( ForumPost forumPost, String commentBody, String author ) {
        // przypadkiem nie powinno być: ( ForumPost forumPost, String author, String commentBody )
    ...
    public int hashCode() {
        ...
        result = 31 * result + commentBody.hashCode();   // DLACZEGO TAKI ZAPIS, 31* ....
        result = 31 * result + author.hashCode();  // DLACZEGO TAKI ZAPIS, 31* ....
        return result;
    }
}
